...
class Screen:
    def __init__(self):
        ...
        # moth push button
        self.overall_button = tk.Button(self.root11, text="Overall", padx=100, pady=10, borderwidth=30,
                                        command=self.overall)
        self.overall_button.place(x=200, y=150)
        self.jan_button = tk.Button(self.root11, text="January", padx=97, pady=10, borderwidth=30, command=self.Jan)
        self.jan_button.place(x=200, y=190)
        self.feb_button = tk.Button(self.root11, text="February", padx=94, pady=10, borderwidth=30, command=self.Feb)
        self.feb_button.place(x=200, y=230)
        self.mar_button = tk.Button(self.root11, text="March", padx=102, pady=10, borderwidth=30, command=self.Mar)
        self.mar_button.place(x=200, y=270)
        self.apr_button = tk.Button(self.root11, text="April", padx=108, pady=10, borderwidth=30, command=self.Apr)
        self.apr_button.place(x=200, y=310)
        self.may_button = tk.Button(self.root11, text="May", padx=109, pady=10, borderwidth=30, command=self.May)
        self.may_button.place(x=200, y=350)
        self.jun_button = tk.Button(self.root11, text="June", padx=107, pady=10, borderwidth=30, command=self.Jun)
        self.jun_button.place(x=200, y=390)
        self.jul_button = tk.Button(self.root11, text="July", padx=110, pady=10, borderwidth=30, command=self.Jul)
        self.jul_button.place(x=200, y=430)
        self.aug_button = tk.Button(self.root11, text="August", padx=102, pady=10, borderwidth=30)
        self.aug_button.place(x=200, y=470)
        self.sep_button = tk.Button(self.root11, text="September", padx=90, pady=10, borderwidth=30, command=self.Sep)
        self.sep_button.place(x=200, y=510)
        self.oct_button = tk.Button(self.root11, text="October", padx=99, pady=10, borderwidth=30, command=self.Oct)
        self.oct_button.place(x=200, y=550)
        self.nov_button = tk.Button(self.root11, text="November", padx=93, pady=10, borderwidth=30, command=self.Nov)
        self.nov_button.place(x=200, y=590)
        self.dec_button = tk.Button(self.root11, text="December", padx=93, pady=10, borderwidth=30, command=self.Dec)
