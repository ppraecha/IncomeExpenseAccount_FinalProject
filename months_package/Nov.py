...
class Screen:
    def __init__(self):
        ...
        # moth push button
        self.overall_button = tk.Button(self.root14, text="Overall", padx=50, pady=10, borderwidth=30,
                                        command=self.overall)
        self.overall_button.place(x=200, y=150)
        self.jan_button = tk.Button(self.root14, text="January", padx=47, pady=10, borderwidth=30, command=self.jan)
        self.jan_button.place(x=200, y=190)
        self.feb_button = tk.Button(self.root14, text="February", padx=44, pady=10, borderwidth=30, command=self.feb)
        self.feb_button.place(x=200, y=230)
        self.mar_button = tk.Button(self.root14, text="March", padx=52, pady=10, borderwidth=30, command=self.mar)
        self.mar_button.place(x=200, y=270)
        self.apr_button = tk.Button(self.root14, text="April", padx=58, pady=10, borderwidth=30, command=self.apr)
        self.apr_button.place(x=200, y=310)
        self.may_button = tk.Button(self.root14, text="May", padx=59, pady=10, borderwidth=30, command=self.may)
        self.may_button.place(x=200, y=350)
        self.jun_button = tk.Button(self.root14, text="June", padx=57, pady=10, borderwidth=30, command=self.jun)
        self.jun_button.place(x=200, y=390)
        self.jul_button = tk.Button(self.root14, text="July", padx=60, pady=10, borderwidth=30, command=self.jul)
        self.jul_button.place(x=200, y=430)
        self.aug_button = tk.Button(self.root14, text="August", padx=51, pady=10, borderwidth=30, command=self.aug)
        self.aug_button.place(x=200, y=470)
        self.sep_button = tk.Button(self.root14, text="September", padx=39, pady=10, borderwidth=30, command=self.sep)
        self.sep_button.place(x=200, y=510)
        self.oct_button = tk.Button(self.root14, text="October", padx=48, pady=10, borderwidth=30, command=self.oct)
        self.oct_button.place(x=200, y=550)
        self.nov_button = tk.Button(self.root14, text="November", padx=42, pady=10, borderwidth=30)
        self.nov_button.place(x=200, y=590)
        self.dec_button = tk.Button(self.root14, text="December", padx=42, pady=10, borderwidth=30, command=self.dec)
